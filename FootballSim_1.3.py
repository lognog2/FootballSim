    ...
    while ((q < 5) or (homeScore == awayScore)):
        ...
        while (clock > 0):
            ...
            # sack
                ...
                gained = random.randint(-10, -1)
                print("\nSacked! A " + str(gained) + " yard loss for " + possession + ".")
                toGoal -= gained
                toFirst -= gained
                down = 1
                down += 1
        ...
        if (q <= 4):
            ...
            Display(toGoal, toFirst, down, possession, homeTeam, awayTeam, clock, q, 'a', awayScore, homeScore)
